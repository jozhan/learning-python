...
def calculates_results_stats(results_dic):
    ...
    for key, value in results_dic.items():
        ...
        if value[3] == 1: # is dog image
            n_dogs_img += 1
            # is dog and is match
            n_correct_breed += value[2]
            # is dog and is classified as dog
            n_correct_dogs += value[4]
        else: # is NON-dog image
            n_notdogs_img += 1
            # is not dog and is classified as not dog
            n_correct_notdogs += (0 if value[4] else 1)
    ...
    # pct_match - n_match / n_images - percentage of correct matches
    results_stats_dic["pct_match"] = n_match / n_images * 100.0
    # pct_correct_dogs - n_correct_dogs / n_dogs_img - percentage of correctly classified dogs
    results_stats_dic["pct_correct_dogs"] = n_correct_dogs / n_dogs_img * 100.0
    # pct_correct_breed - n_correct_breed / n_dogs_img - percentage of correctly classified dog breeds
    results_stats_dic["pct_correct_breed"] = n_correct_breed / n_dogs_img * 100.0
    # pct_correct_notdogs - n_correct_notdogs / n_notdogs_img - percentage of correctly classified NON-dogs
